    ...
    public sealed partial class PdaMenu : PdaWindow
    {
        ...
        public PdaMenu()
        {
            ...
            StationTimeButton.OnPressed += _ =>
            {
                ...
                _clipboard.SetText(RoundTimerUtils.ToString(stationTime)); // Aurora's Song - Allow round timer to go over 24h
            };
        ...
        public void UpdateState(PdaUpdateState state)
        {
            ...
            if (_roundEndTime is not null)
            {
                ...
                RemainingTimeLabel.SetMarkup(Loc.GetString("comp-pda-ui-remaining-time",
                    ("time", RoundTimerUtils.ToString(remainingTime)))); // Aurora's Song - Allow round timer to go over 24h
            }
            // End Frontier
